...
*The joshbot configuration package (`internal/configure/`) includes 12 tests covering edge cases. The pattern is worth studying if you're building configuration systems in Go.*
